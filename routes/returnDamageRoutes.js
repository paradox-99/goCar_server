...
const { createPickup, createReturn, reportDamage, getUserDamageReports, getAgencyDamageReports, updateDamageStatus } = require('../controllers/returnDamageController');
